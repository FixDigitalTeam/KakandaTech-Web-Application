        ...
        <form action="{{ route('dashboard.service.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="flex flex-wrap mx-2 mb-6 mt-2">
            <div class="w-full mt-4 px-3">
              ...
              <input type="text" value="{{ old('NamaLay') }}" name="NamaLay" placeholder="Nama Layanan"
          ...
          <div class="flex flex-wrap mx-2 mb-6 mt-2">
            <div class="w-full mt-4 px-3">
              ...
              <input type="text" value="{{ old('KodeKgr') }}" name="KodeKgr" placeholder="Kode Kategori"
                class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
            </div>
          </div>
          <div class="flex flex-wrap mx-2 mb-6 mt-2">
            <div class="w-full px-3">
              ...
              <input type="text" value="{{ old('Harga') }}" name="Harga" placeholder="Harga Layanan"
                class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
            </div>
          </div>
